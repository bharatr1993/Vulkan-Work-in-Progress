...
////Change cmd bind descriptor set from 4 to 1
...
UpdateScene( )
{
	...
	if( UseRotate )
	{
		if (!Paused)
		{
			...
			glm::mat4 move = glm::translate(glm::mat4(), glm::vec3(-1, 3, -3.));
			Matrices.uModelMatrix = Matrices.uModelMatrix*move;
			//Matrices.uModelMatrix = move;
		}
