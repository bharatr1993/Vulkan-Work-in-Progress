...
main( ) 
{
	...
	mat4  M = Matricestl.uModelMatrix[0];
	...
	#ifdef DO_INSTANCING
		int    NUMINSTANCES = Matricestl.count;
				
		P = Matricestl.uProjectionMatrix;
		M = Matricestl.uModelMatrix[gl_InstanceIndex];
		V = Matricestl.uViewMatrix;
		VM = V * M;
		PVM = P * VM;
